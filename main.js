...
var author$project$Main$NewFaces = function (a) {
	return {$: 1, a: a};
};
...
var author$project$Main$sequenceA = function (genList) {
	return A3(
		elm$core$List$foldr,
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var begin = _n1.a;
				var end = _n1.b;
				var rndListList = author$project$Main$sequenceA(
					A2(
						elm$core$List$map,
						...
						A2(
							elm$core$List$repeat,
							model.A,
							A2(elm$core$List$range, begin, end))));
				return _Utils_Tuple2(
					model,
					A2(elm$random$Random$generate, author$project$Main$NewFaces, rndListList));
			case 1:
				var newFaces = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Main$nDieView = function (model) {
	var toTexts = function (list) {
	...
	return A2(elm$core$List$map, toTexts, model.G);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('n'),
				...
				elm$html$Html$h1,
				_List_Nil,
				author$project$Main$nDieView(model))
			]));
};
